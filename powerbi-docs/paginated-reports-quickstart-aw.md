...
> * 마법사의 도움을 받아 보고서 작성기에서 행렬을 만듭니다.
...
- [Microsoft 다운로드 센터에서 보고서 작성기](http://go.microsoft.com/fwlink/?LinkID=734968)를 설치합니다. 
...
- [Power BI Premium 용량](service-premium.md)에 서비스에 대한 앱 작업 영역이 있어야 합니다. 작업 영역 이름 옆에는 다이아몬드 아이콘(![Premium 다이아몬드 아이콘](media/paginated-reports-quickstart-aw/premium-diamond.png))이 있습니다.

## <a name="create-the-matrix-with-a-wizard"></a>마법사를 사용하여 행렬 만들기
  
1.  컴퓨터에서 보고서 작성기를 시작합니다.  
...
4.  **데이터 세트 선택** 페이지에서 **데이터 세트 만들기** > **다음**을 선택합니다.  
    ...
    ![데이터 집합 만들기](media/paginated-reports-quickstart-aw/power-bi-paginated-create-dataset.png)
...
1. 페이지 맨 위에서 **클릭하여 제목 추가**를 선택하고 **회사별 판매액**을 입력합니다.  
...
2. **홈** 탭에서 달러 기호(**$**) 통화 기호를 선택하고 **자리 표시자 스타일** > **샘플 값** 옆에 있는 화살표를 선택합니다.
...
3. **속성** 창에 **테이블릭스 멤버** 속성이 표시되어 있습니다. **KeepWithGroup**을 **이후**로 설정하고 **RepeatOnNewPage**를 **True**로 설정합니다.
