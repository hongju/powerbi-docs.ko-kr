...
이 자습서에서는 사용자가 샘플 Azure SQL Database에 연결합니다. 그런 다음, Power BI Report Builder의 마법사를 사용하여 여러 페이지로 래핑된 테이블이 포함된 페이지를 매긴 보고서를 만듭니다. 그런 다음, Power BI 서비스에 있는 프리미엄 용량의 작업 영역에 페이지를 매긴 보고서를 업로드합니다.
...
> * 마법사의 도움을 받아 Power BI Report Builder에서 행렬을 만듭니다.
...
- [Microsoft 다운로드 센터에서 Power BI Report Builder](https://go.microsoft.com/fwlink/?linkid=2086513)를 설치합니다. 
