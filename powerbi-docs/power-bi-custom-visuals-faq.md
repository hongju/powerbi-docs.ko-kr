...
관리 포털의 “조직의 사용자 지정 시각적 개체” 탭 아래에서 관리자는 [엔터프라이즈의 모든 조직 사용자 지정 시각적 개체를 확인하고 관리](https://docs.microsoft.com/power-bi/service-admin-portal#organization-visuals)(추가, 사용하거나 사용하지 않도록 설정 및 삭제)할 수 있습니다.
