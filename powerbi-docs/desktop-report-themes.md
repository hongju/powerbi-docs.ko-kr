...
또한 수동으로 색상표의 색 테마 섹션을 사용하여 데이터 요소의 색을 설정하는 경우 해당 색은 새로운 보고서 테마를 적용할 때 업데이트하지 *않습니다*. 기본 색을 다시 가져오려면(그래서 새 보고서 테마를 적용하는 경우 업데이트함) **테마 색상**표에서 **기본값으로 되돌리기**를 선택할 수 있습니다.
