---
title: 새로 고침을 지원하지 않는 데이터 원본 문제 해결
description: 새로 고침을 지원하지 않는 데이터 원본 문제 해결
author: mgblythe
manager: kfile
ms.reviewer: kayu
ms.service: powerbi
...
---
# <a name="troubleshooting-unsupported-data-source-for-refresh"></a>새로 고침을 지원하지 않는 데이터 원본 문제 해결
