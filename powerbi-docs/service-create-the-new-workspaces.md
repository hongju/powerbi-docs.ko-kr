...
Power BI는 Office 365 그룹 멤버 자격을 사용하여 작업 영역 액세스를 갖도록 구성되는 사용자 또는 그룹의 권한을 동기화하지 않습니다. 가장 좋은 방법은 이 Office 365 그룹에서 파일 저장소를 구성하는 동일한 Office 365 그룹에 작업 영역에 대한 액세스 권한을 부여하는 것입니다. 그런 다음 Office 365 그룹의 멤버 자격을 관리하여 작업 영역 액세스를 관리합니다.
