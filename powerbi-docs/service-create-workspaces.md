...
왼쪽 탐색 영역에서는 이전에 설치한 모든 앱을 보여 줍니다. 동료는 몇 가지 다른 방법으로 앱을 설치할 수 있습니다. 
...
* 새 작업 영역 환경 미리 보기를 사용하여 조직 콘텐츠 팩의 사용을 중단하는 첫 번째 조치를 취합니다. 미리 보기 작업 영역에서 조직 콘텐츠 팩을 사용하거나 만들 수 없습니다.
