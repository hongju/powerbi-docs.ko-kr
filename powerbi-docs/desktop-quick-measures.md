...
마우스 오른쪽 단추 메뉴에서 선택하면 다음 **빠른 측정** 창이 나타나고 여기에서 원하는 계산과 계산을 실행할 필드를 선택할 수 있습니다.
...
**값** 필드 영역을 마우스 오른쪽 단추로 클릭하고 **빠른 측정**을 선택하면, *계산*으로 *범주 내 평균*을 선택한 후 *기준 값*으로 *SalesAmount의 합계*를 선택하고 오른쪽 창의 *필드* 상자에서 왼쪽의 *범주* 상자로 해당 필드를 끌어서 *SalesAmount*를 지정할 수 있습니다.
