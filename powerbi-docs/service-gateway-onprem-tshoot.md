...
> [!WARNING]
> 데이터 원본 중 하나가 OAuth 인증을 요구하는 경우 온-프레미스 데이터 게이트웨이를 구성할 수 없습니다. OAuth 인증은 현재 온-프레미스 데이터 게이트웨이와 함께 지원되지 않습니다. 예약된 새로 고침을 구성하려면 Power BI Desktop에서 OAuth 인증을 요구하는 데이터 원본을 제거해야 합니다.
> 
> 
