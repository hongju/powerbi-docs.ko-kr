...
---
# <a name="data-refresh-in-power-bi"></a>Power BI의 데이터 새로 고침
...
| --- | --- | --- | --- | --- | --- |
| 가져오기 | 예약 및 요청 시 | 예, 연결된 데이터 세트의 경우 | 프리미엄 용량에서 사용하도록 설정된 경우 | 자동 및 요청 시 | 예 |
| DirectQuery | 해당 없음 | 예, 연결된 데이터 세트의 경우 | 프리미엄 용량에서 사용하도록 설정된 경우 | 자동 및 요청 시 | 예 |
| LiveConnect | 해당 없음 | 예, 연결된 데이터 세트의 경우 | 프리미엄 용량에서 사용하도록 설정된 경우 | 자동 및 요청 시 | yes |
| 밀어넣기 | 해당 사항 없음 | 해당 없음 | 실용적이지 않음 | 자동 및 요청 시 | 예 |
| | | | | | |
