...
* 상위 행 제거 – 웹 페이지의 테이블이 생성된 방식의 결과이며 필요하지 않습니다. 리본 메뉴 **홈** 탭에서 **행 감소 \>행 제거 \>상위 행 제거**를 선택합니다.
...
* 하위 26개 행 제거 – 모두 지역이므로 포함할 필요가 없습니다. 리본 메뉴 **홈** 탭에서 **행 감소 \> 행 제거 \>하위 행 제거**를 선택합니다.
