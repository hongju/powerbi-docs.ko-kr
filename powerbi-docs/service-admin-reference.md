...
| **Get-PowerBIDashboard -WorkspaceId** | 해당 없음 | 그룹\_GetDashboardsAsAdmin | /v1.0/myorg/admin/groups/{group\_id}/dashboards | 지정된 작업 영역 내에서 대시보드를 가져옵니다. |
