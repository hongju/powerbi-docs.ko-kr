...
**Power BI Desktop**에서 PDF로 보고서를 내보내는 과정은 단순하므로 PDF를 인쇄하거나 다른 사용자와 해당 PDF 문서를 공유할 수 있습니다. Power BI Deskop에서 **파일 > PDF로 내보내기**를 선택하면 됩니다.

**PDF로 내보내기** 과정은 각 보고서 페이지를 PDF에서 단일 페이지로 내보내어 보고서에서 *표시된* 모든 페이지를 내보냅니다. 도구 설명 또는 숨겨진 페이지와 같이 현재 표시되지 않는 보고서 페이지를 PDF 파일로 내보내지 않습니다. 

![과정에서 PDF로 내보내기](media/desktop-export-to-pdf/export-to-pdf_02.png)
...
배경 화면을 PDF로 내보내지지 않으므로 어두운 배경 무늬를 사용하는 보고서에 특별히 주의해야 합니다. 보고서의 텍스트가 밝은 색이나 흰색이면 보고서의 나머지 부분을 사용하여 배경 화면을 내보내지 않으므로 어두운 배경 화면에 대해 두드러져 보이도록 PDF로 내보내기 과정에서 읽기 어렵거나 읽을 수 없게 됩니다. 



## <a name="next-steps"></a>다음 단계
**Power BI Desktop**에는 다양한 종류의 흥미로운 시각적 요소 및 기능이 있습니다. 정보에 대한 자세한 내용은 다음 리소스를 확인하세요.
