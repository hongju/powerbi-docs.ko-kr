...
Premium 용량에서 데이터 흐름 워크로드를 활성화하는 방법을 알아보려면 Power BI Premium의 [워크로드 구성](service-admin-premium-manage.md#configure-workloads) 문서를 참조하세요. 데이터 흐름 워크로드는 현재 Multi-Geo 용량에서 사용할 수 없습니다.
