...
* 로컬 컴퓨터에서 실행되는 무료 응용 프로그램인 **Power BI Desktop**을 다운로드하여 설치합니다. [다운로드 **Power BI Desktop** ](https://powerbi.microsoft.com/desktop) 또는 [**Microsoft 저장소**](http://aka.ms/pbidesktopstore)에서 설치할 수 있습니다.
