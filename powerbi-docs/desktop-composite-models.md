...
DirectQuery를 사용할 때는 주로 사용자에게 좋은 환경을 제공할 충분한 리소스가 백 엔드 원본에 있는지 확인하기 위해 항상 성능을 고려해야 합니다. 좋은 환경이란 시각적 개체가 5초 이내로 새로 고쳐진다는 것을 의미합니다. 성능에 대한 추가 조언은 [Power BI에서 DirectQuery를 사용하는 방법](desktop-directquery-about.md)을 참조하세요.
