...
빌드 권한 유형은 데이터 세트에만 관련이 있습니다. 이를 통해 사용자는 보고서, 대시보드, Q&A의 고정된 타일 및 Insights Discovery와 같은 데이터 세트에 새로운 콘텐츠를 빌드할 수 있습니다. Excel에서 분석을 통한 Excel 시트, XMLA 및 기본 데이터 내보내기와 같이 Power BI 외부의 데이터 세트를 기반으로 새 콘텐츠를 빌드할 수도 있습니다.
