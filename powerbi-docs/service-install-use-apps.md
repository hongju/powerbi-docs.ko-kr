...
이제 앱에서 대시보드 및 보고서의 데이터를 탐색할 수 있습니다. 필터링, 강조 표시, 정렬 및 드릴다운과 같은 모든 표준 Power BI 상호 작용에 액세스할 수 있습니다. 보고서의 테이블 또는 다른 시각적 개체에서 [데이터를 Excel로 내보낼](visuals/power-bi-visualization-export-data.md) 수도 있습니다. [Power BI에서 보고서와 상호 작용](service-reading-view-and-editing-view.md)을 읽어 보세요. 
