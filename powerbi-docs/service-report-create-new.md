...
2. 왼쪽 탐색 표시줄의 맨 아래에서 **데이터 가져오기**를 선택합니다.
...
2. **시각화** 창에서 계기 템플릿 ![](media/service-report-create-new/powerbi-gauge-icon.png)을(를) 선택하여 계기에 대한 시각적 개체를 변환합니다.
...
3. **시각화** 창에서 영역 차트 템플릿 ![](media/service-report-create-new/power-bi-areachart-icon.png)을(를) 선택하여 시각적 개체를 영역 차트로 변환합니다.
4. **시간** > **기간**을 선택하여 **축** 웰에 추가합니다.
   
    ![](media/service-report-create-new/power-bi-report-step5.png)
5. 시각화를 정렬하려면 줄임표를 선택하고 **기간별 정렬**을 선택합니다.
6. 이제 슬라이서를 추가해 보겠습니다. 캔버스의 빈 영역을 선택하고 슬라이서 ![](media/service-report-create-new/power-bi-slicer-icon.png) 템플릿을 선택합니다. 그러면 빈 슬라이서가 캔버스에 추가됩니다.
...
9. 선택적으로 계속 시각화를 추가합니다.

## <a name="next-steps"></a>다음 단계
* [보고서 복사본 만들기](power-bi-report-copy.md)
* [보고서 저장](service-report-save.md)    
