...
**해결 방법:** Power BI에서 데이터 세트의 새로 고침 설정으로 이동합니다. 데이터 소스 관리에서 오류가 있는 모든 데이터 소스에 대해 자격 증명 편집을 클릭하고 데이터 소스에 다시 로그인합니다.
...
**해결 방법:** 이 오류를 해결하려면 익명 인증을 선택합니다. 레거시 ACE OLEDB 공급자에 대한 익명 자격 증명은 Windows 자격 증명과 동일합니다.
