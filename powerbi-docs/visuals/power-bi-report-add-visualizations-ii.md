...
1. **Sales** 테이블에서 **This Year Sales** > **값** 및 **Last Year Sales**을 선택합니다. Power BI에 세로 막대형 차트가 만들어집니다.  이 기능에 대해 자세히 알아보겠습니다. 월별 매출이 어떻게 보이나요?  
   
   ![](media/power-bi-report-add-visualizations-ii/power-bi-barchart.png)
2. Time 테이블에서 **FiscalMonth**을 **축** 영역으로 끌어옵니다.  
...
4. 줄임표(...)를 선택하고 **정렬기준** > **FiscalMonth**를 선택하여 시각화를 정렬합니다.
...
1. **Store** 테이블에서 **Territory**을 선택합니다. Power BI는 해당 지역이 위치인 것을 인식하고 맵 시각화를 만듭니다.  
   ![](media/power-bi-report-add-visualizations-ii/power-bi-map.png)
2. **Total Stores**을 크기 영역으로 끌어 놓습니다.  
