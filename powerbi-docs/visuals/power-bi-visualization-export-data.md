...
1. 새 막대형 차트를 만듭니다.  필드 창에서 **위치 > 도시** 및 **송장 > 할인율**을 선택합니다.  **할인율**을 값 영역으로 옮겨야 할 수도 있습니다. 

    ![](media/power-bi-visualization-export-data/power-bi-export-data3.png)
2. **할인율**에 대한 집계를 **개수**에서 **평균**으로 변경합니다. 값 영역에서 **할인율**(**할인율 개수**라고 할 수도 있음) 오른쪽에 있는 화살표를 선택하고 **평균**을 선택합니다.
