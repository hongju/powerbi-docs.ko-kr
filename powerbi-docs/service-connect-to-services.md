...
>[!IMPORTANT]
>2019년 9월 25일에 몇 가지 콘텐츠 팩이 사용 중단될 예정입니다. 설치된 콘텐츠 팩은 계속 작동하지만 그 후에는 새로 설치할 수 없습니다. [템플릿 앱](https://docs.microsoft.com/power-bi/service-template-apps-overview)은 서비스 콘텐츠 팩을 대체합니다.
