...
Azure의 Power BI Embedded 용량을 사용하여 여러 SKU를 테스트하고 예상 워크로드에 대한 최적의 Premium SKU를 결정합니다. Power BI Embedded A4 SKU는 P1, A5 = P2 및 A6 = P3과 같습니다. Azure에서는 Azure Portal에서 크기를 증가 및 감소하여 SKU 간에 쉽게 전환할 수 있습니다. 워크로드에 가장 적합한 SKU를 찾고 테스트를 완료한 경우 SKU를 삭제할 수 있습니다.
