...
Power BI Premium은 용량 *초과 커밋*의 이점을 제공합니다. 예를 들어 용량이 유지할 수 있는 것보다 많은 데이터 세트를 게시할 수 있습니다. 사용 중인 용량의 게시된 데이터 세트에 여유 용량보다 많은 메모리가 필요한 경우에는 일부 데이터 세트가 영구적 스토리지에 별도로 저장됩니다. 영구적 스토리지는 각 용량과 연결된 100TB 스토리지에 포함됩니다.
