...
Power BI 서비스에는 보고서를 조작할 수 있는 두 가지 모드, 즉 보고서 ‘소비자’를 위한 [읽기용 보기](service-reading-view-and-editing-view.md) 및 보고서 소유자와 작성자를 위한 편집용 보기가 있습니다.  보고서를 공유하고 다른 사용자가 만든 보고서를 편집하려면 Power BI Pro 라이선스가 필요합니다. Pro 라이선스가 없는 경우 보고서를 만들 수 있지만 [공유](service-share-reports.md)할 수는 없습니다.    
