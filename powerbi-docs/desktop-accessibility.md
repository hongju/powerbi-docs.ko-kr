...
시각적 개체 간을 이동할 때 Alt+Shift+**F10**을 눌러 포커스를 시각적 개체 헤더로 이동할 수 있습니다. 시각적 개체 헤더에는 정렬, 차트 뒤의 데이터 내보내기 및 포커스 모드가 포함된 다양한 옵션이 있습니다. 
...
> [!NOTE]
> **데이터 표시** 기능은 이 바로 가기 키를 통해서만 화면 판독기에 액세스할 수 있습니다. 시각적 개체 헤더에서 옵션을 통해 **데이터 표시**를 열면 화면 판독기에 액세스할 수 없습니다. **데이터 표시**를 사용하는 경우 화면 판독기에 제공된 모든 바로 가기 키를 활용하도록 검색 모드를 켭니다.
