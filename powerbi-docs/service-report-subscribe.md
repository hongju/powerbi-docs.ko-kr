...
자신과 동료가 가장 중요한 보고서 페이지, 대시보드 및 페이지가 매겨진 보고서에 구독할 수 있습니다. Power BI 이메일을 받은 편지함으로 스냅샷을 보냅니다. 메일 수신 빈도(초기 데이터 새로 고침 후 매일, 매주, 매시간, 매월 또는 하루에 한 번)를 Power BI에 지정합니다.  매일, 매주, 매시간 또는 매월을 선택하면 구독을 실행할 시간을 선택할 수 있습니다.  모든 보고서 페이지 및 대시보드에 대해 하루 최대 24개의 서로 다른 구독을 설정할 수 있습니다.
