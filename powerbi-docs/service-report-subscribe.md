---
title: 자신과 다른 사람이 Power BI 대시보드 및 보고서 구독
description: 자신과 다른 사람이 Power BI 보고서 페이지, 대시보드 또는 페이지 매긴된 보고서의 스냅숏을 구독 하는 방법에 알아봅니다.
author: maggiesMSFT
manager: kfile
ms.reviewer: ''
featuredvideoid: ''
...
자신과 동료가 보고서 페이지, 대시보드 및 내어 가장 관심 있는 페이지 매긴된 보고서를 구독할 수 있습니다. Power BI를 전자 메일로 받은 편지함에 스냅숏을 보냅니다. Power BI에게 이메일 수신 빈도를 매일, 매주 또는 데이터 새로 고침 후 하루에 한 번 알려줍니다.  선택한 매일 또는 매주, 시간을 선택할 수 있습니다 하는 경우에 구독을 실행 하려고 합니다.  모든 보고서 페이지 및 대시보드에 대해 하루 최대 24개의 서로 다른 구독을 설정할 수 있습니다.
...
## <a name="subscribe-to-a-dashboard-report-page-or-paginated-report"></a>대시보드, 보고서 페이지 또는 페이지 매긴된 보고서를 구독합니다

프로세스 대시보드, 보고서 또는 페이지 매긴된 보고서를 구독 하는지 여부와 비슷합니다. 동일한 단추를 사용하면 Power BI 서비스 대시보드 및 보고서를 구독할 수 있습니다.

페이지 매긴된 보고서를 구독 하는 것은 약간 다릅니다. 참조 [자신과 다른 사람이 Power BI 서비스에서 페이지 매긴된 보고서를 구독할](paginated-reports-subscriptions.md) 세부 정보에 대 한 합니다.
...
7. **저장 후 닫기**를 선택합니다. 구독한 사용자는 선택한 빈도와 시간에 대한 대시보드 또는 보고서 페이지의 이메일과 스냅숏을 수신합니다. 전체적으로 보고서 또는 대시보드당 최대 24개의 구독을 만들 수 있으며, 각 구독마다 고유한 수신자, 시간 및 빈도를 제공할 수 있습니다.  대시보드 또는 보고서에 대해 **데이터 새로 고침 후**로 설정된 모든 구독은 첫 번째 예약된 새로 고침 후에도 계속 이메일만 보냅니다.   
   ...
   > [!TIP]
   > 언제든지 즉시 구독 또는 주문형으로 이메일을 보내시겠습니까? 보낼 대시보드 또는 보고서의 구독에 대해 **지금 실행**을 선택합니다. 해당 특정 구독에 대한 모든 사용자에게 이메일이 전송된다는 알림이 표시됩니다.  원하는 만큼 자주이 수행할 수 있습니다. 보고서 또는 대시보드당 하루 24회 예약된 구독 실행의 제한에 포함되지 않습니다. 기본 데이터 집합의 데이터 새로 고침을 트리거하지 않습니다. 
   > 
   > 
...
* 25개가 넘는 고정된 타일 또는 4개의 고정된 라이브 보고서 페이지가 있는 대시보드는 사용자에게 전송된 구독 이메일에 완벽하게 렌더링되지 않을 수 있습니다.  대시보드 타일의 이러한 수에 대 한 구독 차단 되지 않습니다. 그러나 문제가 발생 하면 지원 되지 않는 간주 합니다. 지원 되는 범위 내에 적절 하 게 수정 하는 것이 좋습니다.
* 전자 메일 구독을 설정할 때 구독 작업을 시작할 때 사이 지연이 전자 메일 전송 되는 정확한 시간에 유지 합니다.  둘 사이의 지연 시간을 최소화 하려면 다른 시간 보다 전자 메일 구독이 실행 되도록 예약 된 경우 예약 된 데이터 새로 고침을 설정 합니다.
* 모든 타일 행 수준 보안 (RLS)이 적용 된 경우에 대시보드 전자 메일 구독에 대 한 해당 타일 표시 되지 않습니다.  
* 보고서 전자 메일 구독에 대 한 데이터 집합에 RLS를 사용 하는 경우 만들 수 있습니다 구독을 직접. 구독할 수 없습니다 다른 보고서 적용 된 행 수준 보안 (RLS)를 사용 하 여 합니다.
...
- [자신과 다른 사람이 Power BI 서비스에서 페이지 매긴된 보고서 구독](paginated-reports-subscriptions.md)
