...
> [!NOTE]
> **Power BI Gateway - personal**의 이전 버전을 권한 상승된 프로세스로 실행 중인 경우, 데이터 집합 자격 증명이 자동으로 업데이트되도록 권한 상승된 새 게이트웨이 설치 프로세스도 시작해야 합니다. 그렇지 않으면 데이터 세트 자격 증명을 수동으로 업데이트해야 합니다.
> 
> 
