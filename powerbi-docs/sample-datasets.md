...
이러한 각각의 샘플은 콘텐츠 팩, 개별 Excel 통합 문서 및 .pbix 파일과 같은 여러 가지 형식으로 제공됩니다. 이러한 것들이 무엇인지 모르거나 어떻게 입수해야 할지 모르는 경우에도 걱정하지 마세요. 이 문서의 뒷부분에서 모두 설명해 드리겠습니다. 또한 각 샘플마다 *둘러보기*를 만들었습니다. 둘러보기는 샘플 뒤에 숨은 이야기를 알려주고 다양한 시나리오를 안내하는 문서입니다. 관리자를 위해 질문에 대답하는 시나리오가 있을 수 있고, 경쟁력 있는 정보를 찾거나 공유할 보고서 및 대시보드를 만들거나 비즈니스 전환을 설명하는 시나리오도 있을 수 있습니다.   

시작하기 전에 샘플 사용 방법에 대한 법적 지침은 다음과 같습니다. 그 후 샘플을 소개하고 사용하는 방법을 보여줍니다.   
...
앞서 말씀드렸다시피 샘플은 콘텐츠 팩, Excel 통합 문서 및 .pbix 파일과 같은 여러 가지 형식으로 제공됩니다. 콘텐츠 팩부터 이러한 형식을 사용하는 방법에 대해 설명하겠습니다.
...
7. 이 경우 비즈니스용 OneDrive에 저장된 **조달 분석 샘플.xlsx** 파일을 선택하고 **연결**을 선택합니다.
