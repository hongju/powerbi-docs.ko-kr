...
예. Pro 라이선스가 없으면 작업 영역에 보고서를 업로드할 수 없습니다. Pro 라이선스가 없어도 Power BI 보고서 작성기를 다운로드하여 사용할 것을 권장하지만 Pro 라이선스 없이 생성한 페이지를 매긴 보고서를 게시할 수 없습니다. 
...
### <a name="the-documentation-says-power-bi-report-builder-is-the-preferred-authoring-tool-can-i-create-paginated-reports-in-sql-server-data-tools-for-power-bi"></a>설명서는 Power BI 보고서 작성기는 기본 작성 도구라고 표시 됩니다. SQL Server Data Tools에서 Power BI용 페이지를 매긴 보고서를 만들 수 있나요?
...
최근에 Power BI 보고서 작성기 페이지를 매긴 보고서에서 Power BI 서비스에 대 한 기본 제작 도구로 출시 되었습니다. [Power BI 보고서 작성기는 Microsoft 다운로드 센터에서](https://go.microsoft.com/fwlink/?linkid=2086513) 설치합니다.
...
현재는 가능하지 않습니다. GA 전에  Power BI Desktop과 마찬가지로 Power BI 보고서 작성기에서 보고서 열기 및 서비스에 직접 게시하는 지원을 추가할 예정입니다. 사용 하 여 수에 대 한 지원이 추가 될 예정입니다.
...
예, 이제 페이지를 매긴 보고서에 대한 데이터 원본으로 Power BI 프리미엄 데이터 집합을 지원 합니다.
...
예, 페이지를 매긴 보고서를 v1과 v2 모두 작업 영역에서 앱 배포 지원 됩니다. 
