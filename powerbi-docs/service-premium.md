...
ms.locfileid: "48271811"
---
# <a name="what-is-microsoft-power-bi-premium"></a>Microsoft Power BI Premium이란?

Microsoft Power BI Premium은 조직 또는 팀에 대해 Power BI 서비스를 실행하는 전용 리소스를 제공합니다. 더욱 신뢰할 수 있는 성능을 제공하고 더 큰 데이터 볼륨을 사용하도록 설정합니다. 또한 Premium을 통해 뷰어를 위한 사용자별 Pro 라이선스를 구입할 필요 없이 광범위하게 콘텐츠를 배포할 수 있습니다.

*프리미엄 용량*에 작업 영역을 할당하여 Power BI Premium을 활용할 수 있습니다. 프리미엄 용량은 조직을 위한 전용 리소스입니다. 프리미엄 용량에 할당되지 않은 작업 영역은 *공유 용량*에 있습니다. 공유 용량을 사용하면 다른 고객이 공유하는 계산 리소스에서 워크로드가 실행됩니다. 
...
다음은 공유 용량과 Premium 용량 간의 차이점에 대한 요약입니다.
...
Power BI Premium 용량의 사용을 시작하려면 작업 영역을 용량에 할당해야 합니다. 프리미엄 용량으로 작업 영역을 지원하면 다음을 얻을 수 있습니다.

* **예약된 새로 고침**: 공유 용량을 사용하면 가져온 모델 데이터 집합의 예약된 새로 고침이 하루 8회로 제한됩니다. Premium 작업 영역에 있는 데이터 집합의 경우 하루 최대 48번까지 새로 고침을 예약할 수 있습니다. Premium 용량에서 DirectQuery 캐시 새로 고침은 하루에 8회로 제한됩니다.

* **전용 하드웨어와 분리**: 공유 용량에서는 다른 워크로드의 리소스 수요가 보고서 및 대시보드의 성능에 영향을 미칠 수 있습니다. 반면에 Premium 용량은 관련되지 않은 워크로드와 분리하여 워크로드에 대해 더 일관되고 신뢰할 수 있는 성능을 제공합니다.
...
>[!NOTE]
>Office 365 전역 관리자가 클릭한 경우에만 이 표의 링크가 제대로 연결됩니다. 다른 사용자가 누르면 404 오류가 표시됩니다.
