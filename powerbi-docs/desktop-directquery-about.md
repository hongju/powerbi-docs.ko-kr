...
* **측정값에 대한 제한 사항:** 측정값에 사용할 수 있는 DAX 함수 및 식은 제한됩니다. 다시 말하자면 자동 완성에서는 나열되는 함수가 제한되며, 잘못된 함수 또는 식이 사용되면 오류가 발생합니다. 이는 자체적으로 성능 문제가 발생할 가능성이 없는 간단한 측정값으로 제한되기 때문입니다.
