...
description: 특별히 휴대폰용 보고서 버전을 만들어 Power BI 휴대폰 앱의 보고서 페이지를 최적화하는 방법을 알아봅니다.
author: maggiesMSFT
manager: kfile
ms.reviewer: ''
ms.service: powerbi
