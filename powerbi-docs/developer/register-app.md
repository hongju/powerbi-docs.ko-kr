...
응용 프로그램을 **Azure Active Directory**에 등록하여 응용 프로그램의 ID를 설정하고 Power BI REST 리소스에 대한 사용 권한을 지정해야 합니다. 콘솔 앱 또는 웹 사이트와 같은 응용 프로그램을 등록하는 경우 응용 프로그램이 사용 권한을 요청한 사용자에게 자신을 식별하기 위해 사용하는 ID를 받습니다.
