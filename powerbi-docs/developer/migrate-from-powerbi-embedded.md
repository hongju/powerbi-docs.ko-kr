---
title: "Power BI Embedded 작업 영역 컬렉션 콘텐츠를 Power BI으로 마이그레이션하는 방법"
...
Microsoft는 최근에 사용자의 콘텐츠 액세스, 공유 및 배포 방법에 대한 유연성을 높여주는 새로운 용량 기반 라이선스 모델인 [Power BI 프리미엄을 발표했습니다](https://powerbi.microsoft.com/blog/microsoft-accelerates-modern-bi-adoption-with-power-bi-premium/). 또한, 이 제품은 Power BI 서비스에 향상된 확장성 및 성능을 제공합니다.
...
> [!IMPORTANT]
> 마이그레이션은 Power BI 서비스에 종속되어 실행되지만, **임베드 토큰** 사용 시 응용 프로그램 사용자의 Power BI에 대한 종속은 없습니다. 응용 프로그램에 임베드된 콘텐츠를 보기 위해 Power BI에 가입할 필요는 없습니다. 이 포함 방법을 사용하여 Power BI가 아닌 사용자에게 서비스할 수 있습니다.
> 
> 
...
**마이그레이션 도구**는 Power BI Embedded에서 Power BI 서비스로 콘텐츠 복사를 지원하기 위해 사용할 수 있습니다. 특히 콘텐츠가 많은 경우입니다. 자세한 내용은 [Power BI Embedded 마이그레이션 도구](migrate-tool.md)를 참조하세요.
...
일부 관련된 코드 조각은 [Power BI Embedded에서 콘텐츠 마이그레이션을 위한 코드 조각](migrate-code-snippets.md)을 참조하세요.
...
6. GET https://api.powerbi.com/v1.0/myorg/datasets/{dataset_id}/Default.GetBoundGatewayDataSources를 호출하여 GW ID 및 데이터 원본 ID 가져오기
...
Power BI Embedded Azure 서비스에서 마이그레이션한 콘텐츠 뿐 아니라 Power BI Desktop을 사용하여 보고서 및 데이터 집합을 만든 다음 앱 작업 영역에 해당 보고서를 게시할 수 있습니다. 보고서를 게시하는 최종 사용자는 앱 작업 영역에 게시하기 위해 Power BI Pro 라이선스가 필요합니다.
...
[Power BI Embedded에서 콘텐츠 마이그레이션을 위한 코드 조각](migrate-code-snippets.md)  
