...
defaultMode     | String        | "Push" 및 "Streaming"의 값을 사용하여 데이터 집합이 푸시, 스트림, 또는 둘다 되는지 여부입니다.      | False        |  False
...
dataType     |  String       |  지원되는 [EDM 데이터 형식](https://msdn.microsoft.com/library/ee382832.aspx) 및 제한 사항입니다. [데이터 형식 제한](#DataTypeRestrictions)을 참조하세요.      |  False       | True        
