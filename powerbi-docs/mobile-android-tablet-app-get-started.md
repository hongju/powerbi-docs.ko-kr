---
title: "Android 태블릿에서 Power BI 모바일 앱 시작"
description: "Android 태블릿용 Power BI 모바일 앱에서 온-프레미스 및 클라우드에 있는 비즈니스 정보에 대한 모바일 액세스를 통해 어디서나 Power BI를 제공하는 방법에 대해 알아봅니다."
services: powerbi
documentationcenter: 
author: maggiesMSFT
manager: kfile
...
![Android 태블릿의 Power BI 대시보드](media/mobile-android-tablet-app-get-started/power-bi-android-tablet-report.png)
...
* **앱 다운로드**  Google Play에서 [Android용 Power BI 앱을 다운로드](http://go.microsoft.com/fwlink/?LinkID=544867)합니다.
  ...
  > 
  > 
* **앱을 열 때 시작** - 등록하거나 로그인하지 않고도 앱을 연 후 로그인 페이지를 넘기면서 Android 태블릿의 Power BI 앱으로 수행할 수 있는 작업에 대한 개요를 빠르게 파악할 수 있습니다. **건너뛰기** 를 탭하여 샘플을 보거나 탐색하고 앱을 실습하세요. 대시보드 홈페이지에서 언제든지 [샘플로 돌아갈](mobile-android-tablet-app-get-started.md#try-the-power-bi-and-reporting-services-samples) 수 있습니다.
...
아직 등록하지 않은 경우, [Power BI 서비스(http://powerbi.com/)](http://powerbi.com/)로 가서 대시보드 및 보고서를 만들어 저장하고, 데이터를 함께 가져오기 위해 자신의 계정을 등록합니다. 그런 다음 Android 태블릿에서 Power BI에 로그인하면 어디서든 대시보드를 볼 수 있습니다.
...
## <a name="get-started-with-the-power-bi-app-on-your-tablet"></a>태블릿에서 Power BI 앱 시작
1. Android 태블릿의 시작 화면에서 Android용 Power BI 앱을 엽니다.
   
   ![Power BI 시작 아이콘](media/mobile-android-tablet-app-get-started/power-bi-logo-android.png)
2. Power BI 대시보드 및 보고서를 보려면 **Power BI**를 누릅니다.  
   ...
   온-프레미스 Power BI Report Server 및 Reporting Services 보고서를 보려면 **Reporting Server**를 누릅니다.
   
   ![Power BI에 로그인](media/mobile-android-tablet-app-get-started/power-bi-connect-to-login.png)
   
   Power BI용 Android 태블릿 앱에서 [Power BI Report Server 및 Reporting Services 보고서 및 KPI를 보려면](mobile-app-ssrs-kpis-mobile-on-premises-reports.md) 보고서 서버 로그인 정보를 입력합니다.
...
1. 왼쪽 위 모퉁이에서 ![전역 탐색 단추](media/mobile-android-tablet-app-get-started/power-bi-android-options-icon.png) 전역 탐색 단추를 탭합니다.
2. **설정** > **샘플 검색**을 탭한 다음 역할을 선택하고 해당 역할에 대한 샘플 대시보드를 탐색합니다. 
   
   ![Power BI 모바일 앱 샘플](media/mobile-android-tablet-app-get-started/power-bi-android-tablet-samples.png)
...
2. **Reporting Services 샘플**을 누른 다음 소매 보고서 또는 판매 보고서 폴더를 열어 KPI 및 모바일 보고서를 탐색합니다.
   ...
   ![Reporting Services 샘플](media/mobile-android-tablet-app-get-started/power-bi-android-tablet-ssrs-samples.png)

## <a name="search-for-a-dashboard-or-report"></a>대시보드 또는 보고서 검색
* 오른쪽 위 모서리의 돋보기를 탭합니다. ![검색 아이콘](media/mobile-android-tablet-app-get-started/power-bi-ipad-search-icon.png)그런 다음 찾으려는 용어를 입력합니다.
  
    ![검색 결과](media/mobile-android-tablet-app-get-started/power-bi-android-tablet-search.png)
...
![Power BI 왼쪽 탐색 창](media/mobile-android-tablet-app-get-started/power-bi-mobile-new-nav-no-numbers.png)

## <a name="view-your-favorite-dashboards-kpis-and-reports"></a>즐겨찾는 대시보드, KPI 및 보고서 보기
모바일 앱의 즐겨찾기 페이지에서 Power BI Report Server 및 Reporting Services 웹 포털에서 KPI 및 보고서와 함께 즐겨 찾는 모든 Power BI 대시보드를 볼 수 있습니다. Power BI 모바일 앱에서 대시보드를 즐겨찾기로 만들면 브라우저의 Power BI 서비스를 포함한 모든 장치에서 액세스할 수 있습니다. 

* **즐겨찾기**를 누릅니다.
  
   ![왼쪽 탐색 창의 즐겨찾기](media/mobile-android-tablet-app-get-started/power-bi-android-favorites-left-nav.png)
  
   Power BI 즐겨찾기와 Power BI Report Server 및 Reporting Services 웹 포털의 즐겨찾기가 모두 이 페이지에 있습니다.
  
   ![즐겨찾기 페이지](media/mobile-android-tablet-app-get-started/power-bi-android-tablet-favorites.png)
...
Power BI의 대시보드 및 보고서와 Power BI Report Server 또는 Reporting Services 웹 포털의 보고서 및 KPI를 사용하여 Power BI용 Android 태블릿 앱에서 수행할 수 있는 몇 가지 다른 작업은 다음과 같습니다.
