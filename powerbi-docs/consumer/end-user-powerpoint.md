---
title: 소비자용 Power BI에서 PowerPoint로 보고서 내보내기
...
4. 게시되는 보고서는 Power BI 설정 또는 브라우저의 로캘 설정에 따른 언어로 렌더링됩니다. 언어 기본 설정을 보거나 설정하려면 톱니바퀴 아이콘 ![](media/end-user-powerpoint/power-bi-settings-icon.png) **> 설정 > 일반 > 언어**를 선택합니다. 로캘 정보는 [Power BI에 지원되는 언어 및 국가/지역](../supported-languages-countries-regions.md)을 참조하세요.
