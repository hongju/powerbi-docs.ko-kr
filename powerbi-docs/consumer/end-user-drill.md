...
1. KY 및 TN에 대한 데이터를 보여주는 최상위 수준의 트리맵에서 시작합니다. 핸들 중 하나를 선택하고 오른쪽으로 끌어서 트리맵을 넓힙니다. 
    ...
    ![2개의 상태를 보여주는 트리맵](./media/end-user-drill/power-bi-drill-down.png) .

2. ***한 번에 모든 필드***를 드릴다운하려면 시각화 왼쪽 위 모서리에 있는 양방향 화살표를 선택합니다. ![더블 드릴다운 아이콘](./media/end-user-drill/power-bi-drill-icon3.png) 이제 트리맵은 켄터키 및 테네시의 도시 데이터를 표시합니다. 
...
3. 다시 드릴업하려면 시각화 왼쪽 위에 있는 위쪽 화살표를 선택합니다. ![](./media/end-user-drill/power-bi-drill-icon5.png)


## <a name="drill-down-one-field-at-a-time"></a>한 번에 한 필드 드릴다운
이 메서드는 시각화 자체의 오른쪽 위 모서리에 표시되는 드릴다운 아이콘을 사용합니다. 

1. 드릴다운 아이콘을 사용하여 ![드릴다운 켜기](./media/end-user-drill/power-bi-drill-icon2.png)를 설정합니다. 이제 ***한 번에 한 필드***를 드릴다운하는 옵션이 표시됩니다. 
...
1. 트리 맵이 활성되면 *아래로 확장* 아이콘을 선택합니다. ![아래로 확장 아이콘](./media/end-user-drill/power-bi-drill-icon6.png) 이제 트리맵은 계층 중 우편 코드 및 상점 이름이라는 2개의 수준을 표시합니다. 

    ![우편 코드 및 상점 이름 표시](./media/end-user-drill/power-bi-expand1.png)
...
3. 드릴다운이 켜져 있는지 확인하고 ![드릴다운 켜기](./media/end-user-drill/power-bi-drill-icon2.png), *아래로 확장* 아이콘을 선택합니다. ![아래로 확장 아이콘](./media/end-user-drill/power-bi-drill-icon6.png) 이제 트리맵은 도시 및 주만 표시하는 대신 추가 세부 정보인 미국 우편 번호도 보여줍니다. 
...
4. 한 번 더 *아래로 확장* 아이콘을 선택하여 트리맵에서 테네시의 모든 4개 계층 수준 세부 정보를 표시합니다. 리프를 마우스로 가리켜서 더 많은 세부 정보를 봅니다.
   ...
   ![테네시 데이터를 표시하는 트리맵](./media/end-user-drill/power-bi-expand-all.png)
...
|확장 모드|연도|분기|월|일|
| ---|:---:|:---:|:---:|---|
|단일|![](./media/end-user-drill/power-bi-hierarchical-year.png)|![](media/end-user-drill/power-bi-hierarchical-quarter.png)|![](./media/end-user-drill/power-bi-hierarchical-one-month.png)|![](media/end-user-drill/power-bi-hierarchical-one-day.png)|
|모두|![](./media/end-user-drill/power-bi-hierarchical-year.png)|![](media/end-user-drill/power-bi-hierarchical-quarter.png)|![](./media/end-user-drill/power-bi-hierarchical-all-month.png)|![](media/end-user-drill/power-bi-hierarchical-all-day.png)|
...
| 확장 모드|지역|시|우편 번호|이름|
| ---|:---:|:---:|:---:|---|
|단일|![](./media/end-user-drill/power-bi-hierarchical-territory.png)|![](media/end-user-drill/power-bi-hierarchical-one-territory-city.png)|![](./media/end-user-drill/power-bi-hierarchical-one-territory-city-postal.png)|![](media/end-user-drill/power-bi-hierarchical-one-territory-city-postal-name.png)|
|모두|![](./media/end-user-drill/power-bi-hierarchical-territory.png)|![](media/end-user-drill/power-bi-hierarchical-all-territory-city.png)|![](./media/end-user-drill/power-bi-hierarchical-all-territory-city-postal.png)|![](media/end-user-drill/power-bi-hierarchical-all-territory-city-postal-name.png)|
