...
1. app.powerbi.com을 열고 **샘플** 링크를 선택합니다. 
    ...
    ![처음으로 열린 Power BI 서비스](./media/end-user-experience/power-bi-new-user.png)
...
![내 작업 영역 화면](./media/end-user-experience/power-bi-my-workspace2.png)
...
![대시보드 열기](./media/end-user-experience/power-bi-open-dashboard.png)
...
1. 대시보드가 열려 있는 상태에서 오른쪽 위 모서리의 **즐겨찾기**를 선택합니다.
   ...
   ![즐겨찾기 추가](./media/end-user-experience/powerbi-dashboard-favorite.png)
...
4. 보고서 이름을 선택하여 보고서 편집기에서 엽니다.
    ...
    ![보고서 열기](./media/end-user-experience/power-bi-report-open.png)
...
![대시보드 검색](./media/end-user-experience/power-bi-search-sort.png)
...
> [Power BI 서비스의 읽기용 및 편집용 보기](end-user-reading-view.md)