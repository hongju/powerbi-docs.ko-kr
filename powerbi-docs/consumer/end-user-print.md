...
1. 인쇄하려는 대시보드를 엽니다.
2. 왼쪽된 위 모퉁이에서 내보내기를 선택 하 고 선택 **이 페이지를 인쇄**합니다.
...
1. 대시보드를 엽니다 [전체 화면 모드](end-user-focus.md) 전체 화면 아이콘을 선택 하 여 ![전체 화면 아이콘](./media/end-user-print/power-bi-full-screen-icon.png) 위 메뉴 모음에서.
3. [타일을 포커스 모드에서 엽니다](end-user-focus.md) 줄임표 (...)를 표시 하려면 마우스로 가리키고 선택 하 여 **포커스 모드로 열기** 또는 포커스 아이콘 ![포커스 아이콘](./media/end-user-print/power-bi-focus-icon.png)합니다.
...
1. 선택한 보고서를 엽니다 **내보낼** > **인쇄** 현재 보고서 페이지를 인쇄할 수 있습니다.
...
2. 왼쪽된 위 모퉁이에서 선택 **내보낼** > **인쇄** 시각적 개체를 인쇄 합니다.
