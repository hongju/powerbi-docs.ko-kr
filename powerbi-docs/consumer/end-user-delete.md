...
2. 삭제할 대시보드를 찾은 후 삭제 아이콘 을 선택합니다. ![삭제 아이콘](./media/end-user-delete/power-bi-delete-icon.png).

    ![비디오](./media/end-user-delete/power-bi-delete-dash.gif)
...
2. 삭제할 보고서를 찾은 후 삭제 아이콘을 선택합니다.   ![삭제 아이콘](./media/end-user-delete/power-bi-delete-icon.png).   

    ![작업 영역의 보고서 탭](./media/end-user-delete/power-bi-delete-reportnew.png)
3. 삭제를 확인합니다.

   ![보고서 삭제 대화 상자](./media/end-user-delete/power-bi-delete-report.png)
...
2. 삭제할 통합 문서를 찾은 후 삭제 아이콘을 선택합니다. ![삭제 아이콘](./media/end-user-delete/power-bi-delete-report2.png) 아이콘.

    ![통합 문서 탭](./media/end-user-delete/power-bi-delete-workbooknew.png)
3. 삭제를 확인합니다.

   ![통합 문서 제거 대화 상자](./media/end-user-delete/power-bi-delete-confirm.png)
...
2. 삭제할 보고서를 찾은 후 줄임표(...)를 선택합니다.  
    ...
    ![데이터 집합 탭](./media/end-user-delete/power-bi-delete-datasetnew.png)
3. 드롭다운 목록에서 **삭제**를 선택합니다.

   ![줄임표 메뉴](./media/end-user-delete/power-bi-delete-datasetnew2.png)
4. 삭제를 확인합니다.

   ![대시보드 삭제 대화 상자](./media/end-user-delete/power-bi-delete-dataset-confirm.png)
...
1. 탐색 창에서 **작업 영역**을 선택합니다.
    ...
    ![앱 작업 영역](./media/end-user-delete/power-bi-delete-workspace.png)
2. 삭제할 보고서 오른쪽의 줄임표(...)를 선택한 후 **작업 영역 편집**을 선택합니다.

   ![줄임표 메뉴 > 작업 영역 편집](./media/end-user-delete/power-bi-edit-workspace.png)
3. **작업 영역 편집** 창에서 **작업 영역 삭제** > **삭제**를 선택합니다.

    ![작업 영역 삭제](./media/end-user-delete/power-bi-delete-workspace2.png)
...
2. 오른쪽 위의 모서리에서 줄임표(...)를 선택하고 **작업 영역 나가기** > **나가기**를 선택합니다.
      ...
      ![작업 영역 나가기](./media/end-user-delete/power-bi-leave-workspace.png)
...
2. 삭제할 앱에 마우스를 올려 놓은 후 삭제 아이콘 ![](./media/end-user-delete/power-bi-delete-report2.png)을 선택합니다.

   ![앱 선택](./media/end-user-delete/power-bi-delete-app.png)

   실수로 앱을 제거할 경우 복구할 수 있는 몇 가지 옵션이 있습니다.  앱 작성자에게 다시 보내달라고 요청하거나, 앱 링크가 포함된 메일 원본을 찾거나 [알림 센터](end-user-notification-center.md)를 확인하여 해당 앱에 대한 알림이 목록에 남아 있는지 살펴보거나 조직의 [AppSource](end-user-apps.md)를 확인할 수 있습니다.

## <a name="considerations-and-troubleshooting"></a>고려 사항 및 문제 해결
이 문서는 Power BI 서비스의 주요 구성 요소를 삭제하는 방법을 소개했습니다. 그러나 Power BI에서 삭제할 수 있는 몇 가지가 더 있습니다.  

* [주요 대시보드 제거](end-user-featured.md#change-the-featured-dashboard)
* [대시보드 제거(즐겨찾기 해제)](end-user-favorite.md)
* [보고서 페이지 삭제](end-user-delete.md)
* [대시보드 타일 삭제](../service-dashboard-edit-tile.md)
* [보고서 시각화 삭제](end-user-delete.md)
