...
1. 보고서 시각화를 마우스로 가리키고 **포커스 모드** 아이콘 ![포커스 모드 아이콘](./media/end-user-focus/pbi_popout.jpg)을 선택합니다.  
...
3. 필터 창을 확장하여 이 시각적 개체에 적용된 모든 필터를 확인합니다.
   ...
   ![필터 화면에서 포커스 모드](./media/end-user-focus/power-bi-display-focus-filters.png)
4. 필터를 수정하여 추가로 탐색하고 흥미로운 점을 발견하는 경우 시각적 요소를 대시보드에 고정합니다.   
