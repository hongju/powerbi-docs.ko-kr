...
![대시보드 전체 화면 모드 전과 후](media/end-user-focus/power-bi-full-screen-comparison.png)
...
보고서 페이지에 대한 메뉴    
![보고서에 대한 메뉴](media/end-user-focus/power-bi-report-menu.png)    
  ...
  * ![화면에 맞춤 아이콘](media/end-user-focus/power-bi-fit-to-width.png)    
...
2. 타일이 열리고 전체 보고서 캔버스를 채웁니다.
   ...
   ![타일은 보고서 캔버스를 채웁니다.](media/end-user-focus/power-bi-tile-focus.png)

3. 필터 창을 확장하여 이 시각적 개체에 적용된 모든 필터를 확인합니다.

   ![필터 창에서 포커스 모드](media/end-user-focus/power-bi-focus-filters.png)
...
5. 포커스 모드에서 나와 시각적 개체의 왼쪽 위 모서리에서 **포커스 모드 종료**를 선택하여 대시보드로 돌아갑니다.
    ...
    ![포커스 모드 나가기](media/end-user-focus/power-bi-tile-exit-focus.png)    
...
2. 왼쪽 아래 모서리의 영역 차트를 마우스로 가리키고 **포커스 모드** 아이콘 ![포커스 모드 아이콘](media/end-user-focus/pbi_popout.jpg)을 선택합니다.  
