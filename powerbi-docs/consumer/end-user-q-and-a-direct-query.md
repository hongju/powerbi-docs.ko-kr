...
* [Power BI 질문 및 답변 소개](end-user-q-and-a.md)
...
1. Power BI의 오른쪽 위에서 톱니바퀴 아이콘 ![기어 아이콘](./media/end-user-q-and-a-direct-query/power-bi-cog.png)을 선택하고 **설정**을 선택합니다.
   
   ![설정 메뉴](./media/end-user-q-and-a-direct-query/powerbi-settings.png)
2. **데이터 집합**을 선택하고 질문 및 답변에 사용할 데이터 집합을 선택합니다.
   
   ![설정 메뉴의 데이터 집합 화면](./media/end-user-q-and-a-direct-query/power-bi-q-and-a-settings.png)
3. **질문 및 답변 및 Cortana**를 확장하고 **이 데이터 집합에 대한 질문 및 답변 설정** 확인란을 선택하고 **적용**을 선택합니다.
   
    ![확장된 질문 및 답변 영역](./media/end-user-q-and-a-direct-query/power-bi-q-and-a-directquery.png)
...
[Power BI 질문 및 답변 개요](end-user-q-and-a.md)  
