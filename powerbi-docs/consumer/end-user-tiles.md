...
* [신속한 정보 활용](end-user-insights.md)
...
[타일 추가](../service-dashboard-add-widget.md)를 사용하여 대시보드에서 이미지, 텍스트 상자, 동영상, 스트리밍 데이터 및 웹 콘텐츠에 대한 독립 실행형 타일을 직접 만들 수 있습니다.
  ...
  ![타일 추가 아이콘](./media/end-user-tiles/add_widgetnew.png)

## <a name="interacting-with-tiles-on-a-dashboard"></a>대시보드에서 타일 조작
### <a name="move-and-resize-a-tile"></a>타일 이동 및 크기 조정
타일을 선택하고 [대시보드 내에서 이동](../service-dashboard-edit-tile.md)합니다. 핸들 ![핸들](./media/end-user-tiles/resize-handle.jpg)을 가리키고 선택하여 타일 크기를 조정합니다.
...
2. 줄임표를 선택하여 타일 동작 메뉴를 엽니다.
    ...
    ![줄임표 아이콘](./media/end-user-tiles/power-bi-tile-menu.png)
   
    여기에서 다음과 같은 작업을 할 수 있습니다.
   
   * [이 타일을 만드는 데 사용된 보고서 열기](end-user-reports.md) ![보고서 아이콘](./media/end-user-tiles/chart-icon.jpg)  
   
   * [이 타일을 만드는 데 사용된 워크시트 열기](end-user-reports.md) ![워크시트 아이콘](./media/end-user-tiles/power-bi-open-worksheet.png)  
     
    * [포커스 모드로 보기](end-user-focus.md) ![포커스 아이콘](./media/end-user-tiles/fullscreen-icon.jpg)  
     * [타일에 사용된 데이터 내보내기](end-user-export-data.md) ![데이터 내보내기 아이콘](./media/end-user-tiles/export-icon.png)
     * [제목 및 부제목 편집, 하이퍼링크 추가![편집 아이콘](./media/end-user-tiles/pencil-icon.jpg)](../service-dashboard-edit-tile.md)
     ...
     * [타일을 다른 대시보드에 고정](../service-pin-tile-to-another-dashboard.md)
       ![고정 아이콘](./media/end-user-tiles/pin-icon.jpg)
     * [타일 제거](../service-dashboard-edit-tile.md)
     ![삭제 아이콘](./media/end-user-tiles/trash-icon.png)
...
[대시보드에 대한 카드(큰 숫자 타일) 만들기](../visuals/power-bi-visualization-card.md)
