...
ms.locfileid: "48908857"
---
# <a name="export-data-from-visualizations"></a>시각화에서 데이터 내보내기
시각화를 만드는 데 사용되는 데이터를 보려는 경우 [Power BI에서 해당 데이터를 표시](end-user-show-data.md)하거나 해당 데이터를 .xlsx 또는 .csv 파일로 Excel에 내보낼 수 있습니다.   
...
과정을 따르려면 [편집용 보기](end-user-reading-view.md)에서 [조달 분석 샘플 보고서](../sample-procurement.md)를 엽니다. [빈 보고서 페이지를 새로 추가합니다](../power-bi-report-add-page.md). 그런 다음 집계와 시각화 수준 필터를 추가하려면 다음 단계를 따릅니다.
...
**기본 데이터**를 선택하면 표시되는 내용은 달라질 수 있습니다. 이러한 세부 정보를 이해하려면 관리자 또는 IT 부서의 도움이 필요합니다. Power BI Desktop 또는 서비스의 보고 보기에서 *측정값*은 계산기 아이콘 ![보여주는 아이콘](./media/end-user-export-data/power-bi-calculator-icon.png)과 함께 필드 목록에 표시됩니다. 측정값은 Power BI 서비스가 아닌 Power BI Desktop에서 생성됩니다.
...
[Power BI의 보고서](end-user-reports.md)  
