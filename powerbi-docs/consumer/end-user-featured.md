...
으로 대시보드를 선택 하는 경우 *추천*때마다 Power BI 서비스를 열고, 해당 대시보드가 표시 된 상태로 열립니다.  

또한 몇 가지 대시보드를 선택하고 *즐겨찾기*로 설정할 수도 있습니다. [대시보드 즐겨찾기](end-user-favorite.md)를 참조하세요.

주요 대시보드를 아직 설정 하지 않은 경우에 Power BI를 사용한 마지막 대시보드에 또는 Power BI 홈으로 열립니다.  
...
2. 상단 메뉴 모음에서에서 줄임표 (...)를 선택 하 고 선택 **주요 대시보드로 설정**합니다.  
...
2. 상단 메뉴 모음에서에서 줄임표 (...)를 선택 하 고 선택 **추천 사용 안 함**합니다.
