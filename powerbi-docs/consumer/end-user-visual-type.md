---
title: 소비자를 위한 Power BI의 시각화 유형
description: Power BI 서비스의 시각화 유형
author: mihart
manager: kvivek
ms.reviewer: ''
ms.service: powerbi
...
이 문서는 Power BI와 함께 패키지로 제공되는 시각화의 개요입니다.  이는 가장 자주 접하게 되는 시각화입니다. 
...
![세로 막대형 차트](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi_nancy_viz_bar.png)

 ![가로 막대형 차트](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi_nancy_viz_col.png)

여러 범주의 특정 값을 살펴보는 데는 가로 막대형 차트가 표준입니다.

### <a name="cards-single-number"></a>카드: 단일 숫자
![단일 숫자 카드](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi_nancy_viz_card.png)
...
![여러 행 카드](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/multi-row-card.png)

여러 행 카드는 행마다 하나 이상의 데이터 포인트를 표시합니다.


### <a name="combo-charts"></a>콤보 차트
![콤보 차트](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/combosmall.png)
...
![도넛형 차트](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/donutsmall.png)
...
![깔데기형 차트](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi_nancy_viz_funnel.png)
...
![계기 차트](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/gauge_m.png)
...
![꺾은선형 차트](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi_nancy_viz_line.png)

꺾은선형 차트는 일반적으로 시간 경과에 따른 전체 값의 전체적인 모양을 강조합니다.

### <a name="maps-basic-maps"></a>지도: 기본 지도
![기본 지도](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi-nancy_viz_map.png)

기본 지도를 사용하여 공간 위치와 범주 및 정량 정보를 연결합니다.

### <a name="maps-arcgis-maps"></a>지도: ArcGIS 맵
![ArcGis 맵](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/power-bi-esri-map-theme2.png)
...
![등치 지역도](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi_nancy_viz_filledmap.png)
...
![도형 맵](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/power-bi-shape-map2.png)
...
### <a name="matrix"></a>행렬
![행렬](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/matrix.png)
...
![원형 차트](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi_nancy_viz_pie.png)
...
![거품형 차트](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi_nancy_viz_bubble.png)
...
![고밀도 분산형](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/density-scatter.png)

정의에 따르면, 고밀도 데이터를 샘플링하여 상호 작용에 응답하는 시각화를 합리적으로 빠르게 만듭니다. 고밀도 샘플링은 겹치는 지점을 제거하고 데이터 세트의 모든 지점이 시각적 개체에 표시되도록 하는 알고리즘을 사용합니다. 단지 데이터의 대표적인 샘플만 플롯하지 않습니다.  
...
![독립 실행형 이미지](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi_nancy_viz_image.png)

독립 실행형 이미지는 보고서 또는 대시보드에 추가된 그래픽입니다. 


### <a name="tables"></a>테이블
![테이블 차트](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/tabletype.png)
...
![트리맵 차트](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/pbi_nancy_viz_tree.png)
...
![폭포 차트](../visuals/media/power-bi-visualization-types-for-reports-and-q-and-a/waterfallsmall.png)
