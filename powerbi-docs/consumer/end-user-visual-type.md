...
ArcGIS 지도와 Power BI의 조합은 지도 상 요소의 표현을 넘어서 완전히 새로운 수준으로 매핑합니다. 기본 지도, 위치 유형, 테마, 기호 스타일 및 참조 계층에 대한 사용 가능한 옵션으로 멋진 정보 제공용 지도 시각적 개체를 만듭니다. 공간 분석과 지도의 신뢰할 수 있는 데이터 계층(예: 인구 조사 데이터)의 조합은 시각적 개체에 있는 데이터에 대한 심도 있는 이해를 제공합니다.
