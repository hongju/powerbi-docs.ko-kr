...
이 문서는 Power BI를 사용 하 여 패키지 된 시각적 개체의 개요입니다.  이 가장 자주 발생 하는 시각적 개체입니다. 
...
이러한 시각적 개체의 모든 Power BI 앱에서 대시보드, 보고서에서 찾을 수 있습니다 하 고 [질문 및 답변에 지정 된](end-user-q-and-a.md)합니다. 시각적 개체 상호 작용 하는 방법에 알아보려면 참조 [보고서, 대시보드 및 앱의 시각적 개체와 상호 작용](end-user-visualizations.md)
