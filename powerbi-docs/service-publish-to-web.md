...
**웹에 게시** embed 태그를 만들고 공유하면 보고서가 변경된 내용으로 업데이트됩니다. 그러나 업데이트가 사용자에게 표시되는 데 시간이 걸릴 수 있다는 점을 알고 있어야 합니다. 보고서 또는 시각적 개체 업데이트는 웹에 게시 embed 코드에 적용되는 데 약 1시간이 걸립니다.
